...
export function Hero({ src }: { src: string }) {
  return (
      <HeroHighlight src={src} className="text-left from-yellow-400 to-amber-400" containerClassName="justify-start h-72 md:h-96 lg:h-[35rem]" bgClassName="h-full brightness-75">
